        ...
        <div className="card-body">
          ...
          <form className="form" onSubmit={(e) => e.preventDefault()} noValidate>
            ...
            <div className="field">
              ...
              <input className="input" id="email" name="email" type="email" placeholder="jane@example.com" autoComplete="email" />
            </div>
            ...
            <div className="field">
              ...
              <input className="input" id="confirm" name="confirm" type="password" placeholder="••••••••" autoComplete="new-password" />
            </div>

            <div className="actions">
              <button className="button" type="submit">Create account</button>
              <div className="helper">Already have an account? <a className="link" href="/user/login">Sign in</a></div>
            </div>
          </form>
